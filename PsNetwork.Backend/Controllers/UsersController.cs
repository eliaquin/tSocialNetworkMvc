...
namespace PsNetwork.Backend.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserId,FirstName,LastName,UserTypeId,Picture,Email,StatusId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UserId,FirstName,LastName,UserTypeId,Picture,Email,StatusId")] User user)
        {
            if (ModelState.IsValid)
            {
